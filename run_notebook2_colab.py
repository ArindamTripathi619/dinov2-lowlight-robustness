"""
Notebook 2 (Colab): DINOv2 Advanced Low-Light Analysis
========================================================
...
from utils import (
    ...
    train_linear_probe, bootstrap_accuracy_ci,
    compute_cka_matrix,
    plot_accuracy_vs_severity, plot_bootstrap_ci, plot_cka_heatmap,
    plot_frequency_test, plot_corruption_grid,
    save_fig, setup_output_dir,
)
import matplotlib.pyplot as plt

OUTPUT_DIR = setup_output_dir("/content/output/notebook2")
